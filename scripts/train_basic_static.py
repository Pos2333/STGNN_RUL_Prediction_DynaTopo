...
#   7. 训练完成后保存最佳模型到 saved_models/retrained_20260826/
#   8. 记录训练日志到 logs/
# ============================================================
...
def save_checkpoint(model, optimizer, epoch, best_loss,
                    ...
                    filepath='saved_models/retrained_20260826/original_paper_static/stgnn/stgnn_static_checkpoint.pt'):
    """保存训练状态，支持断点续训"""
...
# ============================================================
def load_checkpoint(model, optimizer, filepath='saved_models/retrained_20260826/original_paper_static/stgnn/stgnn_static_checkpoint.pt'):
    """从 checkpoint 恢复训练状态"""
...
def train(model, train_loader, val_loader, loss_fn, optimizer, edge_index, device,
          ...
          resume=False, checkpoint_path='saved_models/retrained_20260826/original_paper_static/stgnn/stgnn_static_checkpoint.pt'):
    ...
    for epoch in range(start_epoch, num_epochs):
        ...
        if val_loss < best_loss:
            ...
            best_model_path = 'saved_models/retrained_20260826/original_paper_static/stgnn/stgnn_static_best_FD001.pt'
...
if __name__ == '__main__':
    ...
    best_checkpoint = torch.load('saved_models/retrained_20260826/original_paper_static/stgnn/stgnn_static_best_FD001.pt')
    ...
    print(f"  最佳模型保存在: saved_models/retrained_20260826/original_paper_static/stgnn/stgnn_static_best_FD001.pt")
