# ============================================================
# scripts/evaluate_1.py —— 单工况预测性能对比实验
# ============================================================
# TODO 4: 在 FD001 测试集上公平对比 LSTM 与 STGNN 的预测性能
#
# 对比指标:
#   - RMSE（均方根误差，越低越好）
...
def evaluate_stgnn(test_loader, edge_index, device,
                   model_path='saved_models/stgnn_best_FD001.pt'):
    """
    加载 STGNN 最佳模型并在测试集上预测

    注意: STGNN 推理时需要传入 edge_index，且要按 batch 扩展
    """
    print(f"\n{'='*60}")
    print(f"  🔍 评估 STGNN (MSTCN + GAT + Transformer)")
    print(f"{'='*60}")
...
if __name__ == '__main__':
    ...
    print("  BasicLSTM vs STGNN (MSTCN + GAT + Transformer)")
    print("=" * 65)
