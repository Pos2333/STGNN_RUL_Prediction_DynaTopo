...
#   2. 使用 cnn-lstm_Model（1D-CNN 提取局部特征 + LSTM 捕捉长时依赖）
...
def save_checkpoint(model, optimizer, epoch, best_loss, train_losses, val_losses,
                    filepath='saved_models/retrained_20260826/original_paper_static/baselines/cnn-lstm_checkpoint.pt'):
    """保存训练状态，支持断点续训"""
...
# ============================================================
def load_checkpoint(model, optimizer, filepath='saved_models/retrained_20260826/original_paper_static/baselines/cnn-lstm_checkpoint.pt'):
    """从 checkpoint 恢复训练状态"""
...
def train_one_epoch(model, dataloader, loss_fn, optimizer, device):
    ...
    for X_batch, y_batch in dataloader:
        ...
        # 前向传播（cnn-lstm_Model 内部自动处理 permute）
...
def train(model, train_loader, val_loader, loss_fn, optimizer, device,
          ...
          resume=False, checkpoint_path='saved_models/retrained_20260826/original_paper_static/baselines/cnn-lstm_checkpoint.pt'):
    """CNN+LSTM 模型主训练循环"""
    # ---- 尝试恢复训练 ----
    if resume:
    ...
    for epoch in range(start_epoch, num_epochs):
        ...
        if val_loss < best_loss:
            ...
            best_model_path = 'saved_models/retrained_20260826/original_paper_static/baselines/cnn-lstm_best_FD001.pt'
...
def save_training_log(train_losses, val_losses, val_rmses, val_nasa_scores, subset='FD001'):
    ...
    log_path = f'logs/cnn-lstm_{subset}_{timestamp}.json'
...
if __name__ == '__main__':
    ...
    best_checkpoint = torch.load('saved_models/retrained_20260826/original_paper_static/baselines/cnn-lstm_best_FD001.pt')
